      ...
      >
        ...
        {type !== "list" && (
          <>
            ...
            Recompénsate por tus viajes: desbloquea ahorros instantáneos del 10% o
              más con una cuenta gratuita de V&Vbooking.
            </p>
            ...
            <div className="headerSearch">
              ...
              <div className="headerSearchItem">
                ...
                <span
                  ...
                  className="headerSearchText"
                >{`${options.adult} adulto(s) · ${options.children} niño(s) · ${options.room} habitación(es)`}</span>
                {openOptions && (
                  <div className="options">
                    ...
                    <div className="optionItem">
                      <span className="optionText">Habitación</span>
                      <div className="optionCounter">
                        <button
